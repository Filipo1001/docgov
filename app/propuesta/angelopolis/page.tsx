...
/**
 * Propuesta comercial para la Alcaldía de Angelópolis.
 *
 * Vive en el ápice —contratistadigital.com/propuesta/angelopolis— y no en el
 ...
 *
 * SELLO TIPOGRÁFICO EN LUGAR DE ESCUDO. El municipio no aportó escudo, así
 * que la portada lleva la inicial en el mismo cuadrado de 48 px que ocupan
 * los escudos de las otras propuestas. Se prefiere a dejar el hueco —la
 * portada perdería su anclaje al municipio— y a inventar un escudo, que en un
 * documento institucional sería peor que no ponerlo. Si más adelante llega el
 * escudo oficial, basta con dejarlo en public/marca/escudo-angelopolis.png:
 * `hayEscudo()` lo detecta y sustituye el sello sin tocar código.
 *
...
export const metadata: Metadata = {
  title: 'Propuesta · Alcaldía de Angelópolis — Contratista Digital',
...
/**
 * Angelópolis no aportó escudo, así que el sello es tipográfico: la inicial
 * del municipio en el mismo cuadrado de 48 px que ocupan los escudos de las
 * otras propuestas. Se prefiere a dejar el hueco —la portada perdería su
 * anclaje al municipio— y a inventar un escudo, que en un documento
 * institucional sería peor que no ponerlo.
 */
const ESCUDO = '/marca/escudo-angelopolis.png'
function hayEscudo(): boolean {
  try {
    return fs.existsSync(path.join(process.cwd(), 'public', 'marca', 'escudo-angelopolis.png'))
  } catch {
    return false
  }
}
        ...
        <div className="max-w-3xl mx-auto w-full">
          ...
          <Revelar retraso={120}>
            <h1 className="mt-10 text-4xl sm:text-6xl font-bold tracking-tight leading-[1.08]">
              Que ningún contrato de Angelópolis vuelva a quedarse sin expediente completo.
            </h1>
          </Revelar>
          ...
          <Revelar retraso={400}>
            <div className="mt-12 sm:mt-16 flex items-center gap-3">
              {escudo ? (
                ...
                <img
                  src={ESCUDO}
                  alt="Escudo del municipio de Angelópolis"
                  className="w-12 h-12 object-contain"
                />
              ) : (
                /* Sello tipográfico mientras no haya escudo. Ocupa el mismo
                   cuadrado que ocuparía el blasón para que la portada no
                   cambie de composición cuando llegue el definitivo. */
                <span
                  aria-hidden="true"
              ...
              <p className="text-xs text-white/40 leading-snug">
                Propuesta preparada para la<br />Alcaldía Municipal de Angelópolis
              </p>
            </div>
          </Revelar>
        </div>
            ...
            <div className="rounded-2xl border border-gray-100 p-6">
              ...
              <div className="mt-3 space-y-2 text-sm text-gray-600">
                {[
                  ...
                  'Adaptación de los documentos al formato de Angelópolis',
        ...
        <div className="max-w-3xl mx-auto">
          <Revelar>
            ...
            <p className="mt-8 text-2xl sm:text-3xl font-bold tracking-tight leading-snug">
              Hablemos de cómo se vería el primer ciclo en Angelópolis.
            </p>
          </Revelar>

          <Revelar retraso={200}>
            <a
              href={enlaceWhatsApp('Buen día. Soy de la Alcaldía de Angelópolis y quisiera conocer más sobre Contratista Digital.')}
              target="_blank"
          ...
          <Revelar retraso={320}>
            <p className="mt-16 text-xs text-white/30">
              Contratista Digital · Propuesta para la Alcaldía Municipal de Angelópolis
            </p>
          </Revelar>
        </div>
      </section>
