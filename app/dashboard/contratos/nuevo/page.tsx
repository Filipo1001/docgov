...
export default function NuevoContratoPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!muni) {
      toast.error('No se encontró el municipio')
      setGuardando(false)
      return
    }
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-gray-500 mb-8">Registra un contrato de prestación de servicios.</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea name="objeto" value={form.objeto} onChange={handleChange} required rows={3}
                placeholder="PRESTAR LOS SERVICIOS DE APOYO A LA GESTIÓN PARA..."
                className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white outline-none resize-none" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="valor_letras_total" value={form.valor_letras_total} onChange={handleChange}
                placeholder="VEINTICUATRO MILLONES DE PESOS M/L"
                className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white outline-none" />
            </div>
            <div>
